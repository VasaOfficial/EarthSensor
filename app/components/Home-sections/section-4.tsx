      ...
      <article className="z-10 md:min-h-[40rem] flex flex-col items-center gap-24 lg:gap-0 lg:flex-row w-full max-w-[70rem]">
        ...
        <div className="flex flex-col justify-center items-center text-center max-w-md h-350 ml-8 bg-white shadow rounded-md p-7">
          ...
          <p className="font-medium text-center">
            ...
            target for air pollution is 0-10 µg/m³. IQ Air, which measures pollution in 109
            countries around the globe, considers measurements above 35.5 to be unhealthy for
            sensitive groups, levels between 55.5 and 150.4 to be unhealthy for all, and anything
            higher is either very unhealthy (150.5-250.4) or hazardous (250.5 or higher).
          </p>
        </div>
      </article>
    </section>
