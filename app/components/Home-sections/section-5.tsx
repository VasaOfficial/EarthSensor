      ...
      <section className="w-full relative flex flex-col items-center bg-white mx-auto text-lg justify-center">
        ...
        <div className="relative flex-col gap-28 w-full max-w-[60rem] flex justify-center items-center">
          <h2 className="text-3xl w-full md:w-1/2 lg:w-2/5 text-center">
            <b className="font-serif opacity-50">“ </b>Covid19 showed part of the world what
            it&apos;s like living with fresh air
          ...
          <div className="relative md:w-4/5 max-sm:max-w-[90%]">
            <ReactCompareSlider
              ...
              position={20}
              itemOne={<ReactCompareSliderImage src="/assets/before.jpg" alt="Image one" />}
              itemTwo={
                <ReactCompareSliderImage
        ...
        <div className="flex flex-col items-center justify-center gap-6 max-w-[60rem] py-28 md:pb-40 px-[5vw] bg-white relative mx-auto text-lg">
          ...
          <p className="font-medium">
            The global response to the COVID-19 pandemic has resulted in unprecedented reductions in
            economic activity. We find that, after accounting for meteorological variations,
            lockdown events have reduced the population-weighted concentration of nitrogen dioxide
            and particulate matter levels by about 60% and 31% in 34 countries, with mixed effects
            on ozone. Reductions in transportation sector emissions are largely responsible for the
            NO2 anomalies.
          </p>
        </div>
      </section>
