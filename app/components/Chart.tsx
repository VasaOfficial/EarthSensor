...
export default function Chart({ data, name, currentIaqi }: ChartProps) {
  const polluantsDefinition: PolluantsDefinition = {
    'PM2.5':
    ...
    PM10: 'Particulate matter (PM10) describes inhalable particles, with diameters that are generally 10 micrometers and smaller.',
    O3: "Ozone (O3) is a highly reactive gas composed of three oxygen atoms. It is both a natural and a man-made product that occurs in the Earth's upper atmosphere",
    NO2: 'Nitrogen dioxide (NO2) is a toxic reddish brown gas that is a strong oxidizing agent. It is produced by combustion (as of fossil fuels), and is an atmospheric pollutant',
    SO2: 'Sulfur dioxide (SO2) is a heavy pungent toxic gas that is easily condensed to a colorless liquid. It is used especially in making sulfuric acid, in bleaching, as a preservative, and as a refrigerant, and is a major air pollutant especially in industrial areas',
    CO: 'Carbon monoxide (CO) is a colorless odorless very toxic gas CO that is formed as a product of the incomplete combustion of carbon or a carbon compound',
  }
      ...
      <div className="relative flex flex-col justify-center items-center w-24 text-right p-3 border-2 rounded-md">
        ...
        <p className="flex flex-col items-center">
          ...
          <i className="text-xs ml-1">
            {name === 'O3' ? 'μg/m3' : name === 'PM2.5' ? 'μg/m3' : name === 'PM10' ? 'μg/m3' : ''}
          </i>
        </p>
      </div>
      ...
      <div className="w-full h-full overflow-hidden pt-2">
        <ResponsiveContainer width="100%" height="100%" debounce={100}>
          ...
          >
            ...
            />
            <XAxis dataKey="day" tickFormatter={(e: Date) => format(new Date(e), 'dd MM')} />
