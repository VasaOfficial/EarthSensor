    ...
    <section
      ...
      <div className='z-10 relative flex items-center justify-center w-[90vw] h-[25rem] sm:h-[40rem] max-w-[80rem] margin-auto'>
        <div className='w-10/12 h-full sm:h-5/6 absolute left-0 top-0 '>
          <figure id='divider'className='relative w-full h-full max-h-full max-w-full '>
            <Image
              src={Pollution}
              alt='air pollution'
              priority={true}
        ...
        <div
          id='card'
          className='absolute -bottom-17 sm:bottom-1 md:bottom-17 right-0 md:w-1/2 w-10/12 bg-emerald-400 flex flex-col gap-4 sm:gap-8 items-center justify-between py-6 px-8 shadow-xl'>
